...
export const api = {
  ...
  async deviceAuth(deviceId: string, language?: string) {
    const response = await apiClient.post('/auth/device', { device_id: deviceId, language })
    return response.data
  },

  async sendPhoneCode(phone: string, purpose: string) {
    const response = await apiClient.post('/auth/phone/send-code', { phone, purpose })
    return response.data
  },

  async verifyPhoneCode(phone: string, code: string, purpose: string) {
    const response = await apiClient.post('/auth/phone/verify', { phone, code, purpose })
    return response.data
  },
  ...
  async deleteData() {
    const response = await apiClient.delete('/privacy/delete')
    return response.data
  },
