...
export default function AstrologyModule({ profile }: AstrologyModuleProps) {
  ...
  const calculateCompatibility = () => {
    ...
    setCompatibilityResult({
      score,
      reading: `The planetary geometry with ${partnerName}'s ${partnerSign} signifies an exquisite karmic conjunction. Focus on empathetic communication during Mercury retrogrades.`
    });
  };
