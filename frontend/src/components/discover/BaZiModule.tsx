...
export default function BaZiModule({ profile }: BaZiModuleProps) {
  ...
  const luckCycleForecasts: Record<number, { title: string; desc: string; focus: string }> = {
    20: { title: "Pillar of Early Blossoms", desc: "Intense intellectual curiosity. Foundational skills under strong Resource element luck.", focus: "Direct Resource" },
    30: { title: "Pillar of Professional Expansion", desc: "Day Master highly supported by Officer energies. Massive professional growth.", focus: "Direct Officer" },
    40: { title: "Pillar of Inner Sovereignty", desc: "Wealth stars combine with self-expression. High entrepreneurial drive.", focus: "Indirect Wealth" },
    50: { title: "Pillar of Sage Abundance", desc: "Stabilising element influences. Transitioning into legacy consulting.", focus: "Friend Star" },
  };
